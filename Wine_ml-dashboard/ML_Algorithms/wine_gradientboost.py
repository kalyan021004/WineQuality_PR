...
# - results/gb_confusion_matrix.png
# - results/gb_roc_curve.png
# ============================================================
...
# predict_proba is available for GradientBoostingClassifier
...
with open("models/gb_metrics.json", "w") as f:
    json.dump(metrics, f, indent=4)
print("✓ Saved: models/gb_metrics.json")
...
plt.tight_layout()
plt.savefig("results/gb_confusion_matrix.png", dpi=300)
plt.close()
print("✓ Saved: results/gb_confusion_matrix.png")
...
plt.title("ROC Curve - Gradient Boosting (3-Class)", fontsize=14)
plt.legend()
plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("results/gb_roc_curve.png", dpi=300)
plt.close()
print("✓ Saved: results/gb_roc_curve.png")
