...
print("✓ Saved: models/catboost_metrics.json")
...
plt.tight_layout()
plt.savefig("results/catboost_confusion_matrix.png", dpi=300)
plt.close()

print("✓ Saved: results/catboost_confusion_matrix.png")
...
plt.title("ROC Curve - CatBoost (3-Class)", fontsize=14)
plt.legend()
plt.grid(alpha=0.3)
plt.savefig("results/catboost_roc_curve.png", dpi=300)
plt.close()

print("✓ Saved: results/catboost_roc_curve.png")
