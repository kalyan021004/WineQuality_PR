# ============================================================
# 🍷 Wine Quality - Support Vector Machine (3-Class)
# Outputs:
# - models/svm_model.pkl
# - models/svm_metrics.json
# - results/svm_confusion_matrix.png
# - results/svm_roc_curve.png
# ============================================================
...
print("✓ Saved: models/svm_metrics.json")
...
plt.title("ROC Curve - SVM (3-Class)", fontsize=14)
plt.legend()
plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("results/svm_roc_curve.png", dpi=300)
plt.close()

print("✓ Saved: results/svm_roc_curve.png")
