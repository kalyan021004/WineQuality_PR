...
print("✓ Saved: models/xgb_metrics.json")
...
plt.title("Confusion Matrix - XGBoost (3-Class)", fontsize=14)
plt.tight_layout()
plt.savefig("results/xgb_confusion_matrix.png", dpi=300)
plt.close()

print("✓ Saved: results/xgb_confusion_matrix.png")
...
plt.title("ROC Curve - XGBoost (3-Class)", fontsize=14)
plt.legend()
plt.grid(alpha=0.3)
plt.tight_layout()
plt.savefig("results/xgb_roc_curve.png", dpi=300)
plt.close()

print("✓ Saved: results/xgb_roc_curve.png")
